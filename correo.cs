...
namespace WindowsFormsApp2
{
    internal class correo
    {
        public void EnviarCorreo(string error)
        {
            try
            {
                var fromAddress = new MailAddress("112599@alumnouninter.mx", "Sistema Exportar"); // Reemplaza con tu correo
                ...
                var smtp = new SmtpClient
                {
                    ...
                    Credentials = new NetworkCredential("112599@alumnouninter.mx", "Mayki.uni1213") // Reemplaza con tus credenciales
                };
